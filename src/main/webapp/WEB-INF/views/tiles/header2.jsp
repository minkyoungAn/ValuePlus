...
<body>
	...
	<header>
		...
		<div class="search"
			style="width: 100px; margin-right: 20px; margin-top: 10px;">
			<a href="${pageContext.request.contextPath}/"><button
					style="width: 70px;" class="ValP">돌아가기</button></a>
		</div>
	</header>
	<div class="side-header">
		...
		<div class="menu">
				...
				<li><a href="${pageContext.request.contextPath}/guideMain" id="guide_a">경매가이드</a></li>
				<li><a
					href="${pageContext.request.contextPath}/questionToAdmin" id="admin_a">관리자
						문의</a>
			</ul>
			<c:choose>
				<c:when test="${!isAdmin&&isUser}">
